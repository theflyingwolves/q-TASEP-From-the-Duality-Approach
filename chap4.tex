...
\begin{figure}
	...
	\caption[The contours $\tilde{C}_{\varphi}$(left) and $C_{\varphi}$(right)]
	{An illustration of the two contours $\tilde{C}_{\varphi}$(left) and $C_{\varphi}$(right) for the parameter $q = 0.5$ and $\theta = 1.5$}
